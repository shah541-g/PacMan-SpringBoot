...
import Runner.SinglePlayerRunner.SinglePlayerRunner;
...
public class HomePage {
    ...
    private void showHomePage(){
        ...
        // Create a panel for the "Single Player Game" card
        ...
        JLabel singlePlayerLabel = new JLabel("Single Player Game", SwingConstants.CENTER);
        ...
        // Add a click event to the Single Player card
        singlePlayerCard.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                // JOptionPane.showMessageDialog(frame, "Single Player Game clicked!");
