...
public class MultiPlayerGameController implements ActionListener,KeyListener{
    ...
    private void moveRedPacman(KeyEvent e){
        ...
        if(e.getKeyCode() == KeyEvent.VK_W){
            MovementManager.updateDirection(Directions.UP.getSymbol(), game.getWalls(), game.getRedPacman());
        }
        else if(e.getKeyCode() == KeyEvent.VK_S){
            MovementManager.updateDirection(Directions.DOWN.getSymbol(), game.getWalls(), game.getRedPacman());
        }
        else if(e.getKeyCode() == KeyEvent.VK_A){
            MovementManager.updateDirection(Directions.LEFT.getSymbol(), game.getWalls(), game.getRedPacman());
        }
        else if(e.getKeyCode() == KeyEvent.VK_D){
            MovementManager.updateDirection(Directions.RIGHT.getSymbol(), game.getWalls(), game.getRedPacman());
        }
    }
